...
?>
  <?php 
  dpm($items);
//  print "<P><P><P>-----------label:".$label."---deltay:".$delta."------shamone<P>" ?>
<<?php print $tag; ?> class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <div class="field-items"<?php print $content_attributes; ?>>
    ...
    <?php
      $output_str .= "";
      $item_key = key($item);
      $termids[] = $item['#options']['entity']->tid;
     ?>  
     <?php endforeach; ?>
    <?php
        ...
        $termstext = rtrim($termstext, ", ");
			  print '<div class="field"><div class="field-title"><h2>'.$label.'</h2> </div><div class="field-value">'. $termstext .'</div></div>';    
      print $output_str;
    ?>        
  </div>
