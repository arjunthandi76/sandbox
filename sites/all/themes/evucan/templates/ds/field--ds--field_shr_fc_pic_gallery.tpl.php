...
?>
    ...
    <?php
      ...
      $contentexists= false;
    ?>
  <div class="sub-gallery field-items">
    ...
    <?php
      ...
      //$value = $item['entity']['field_collection_item'][$item_key]['field_tel_no']['#items'][0]['value'];
      $img_url = $item['entity']['field_collection_item'][$item_key]['field_picture']['#object']->field_picture[LANGUAGE_NONE][0]['uri'];
      $large_img_url = $item['entity']['field_collection_item'][$item_key]['field_picture'][0]['#url'];
      $title = $item['entity']['field_collection_item'][$item_key]['field_picture']['#object']->field_pic_title[LANGUAGE_NONE][0]['value'];
      $thumb = image_style_url("medium", $img_url);
      //$code = '<div class ="sub-gallery-pic"><a  class="centered" rel="shadowbox;width=640;height=480;player=swf" title="'. $title .'" href="http://www.youtube.com/v/'. $video_id .'&amp;hl=en&amp;fs=1&amp;rel=0&amp;autoplay=1"><img alt="'. $title .'" src="'. $thumb .'"></a></div>';

      $code .= '<div class="sub-gallery-pic"><a  class="centered" rel="shadowbox" title="'. $title .'" href="' .$large_img_url. '"><img alt="'. $title .'" src="'. $thumb .'"></a></div>';
      $contentexists= true;
    ?>
    <?php endforeach; ?>
    <?php
