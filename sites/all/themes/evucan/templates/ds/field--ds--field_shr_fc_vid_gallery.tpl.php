...
?>
  ...
  <?php
    ...
    $contentexists= false;
  ?>
  <div class="sub-gallery field-items"<?php print $content_attributes; ?>>
    ...
    <?php
      ...
      $video_id = $item['entity']['field_collection_item'][$item_key]['field_youtube_link']['#object']->field_youtube_link[LANGUAGE_NONE][0]['video_id'];
      $title = $item['entity']['field_collection_item'][$item_key]['field_video_title']['#items'][0]['value'];
      $thumb = $base_url . "/sites/default/files/youtube/".$video_id . ".png";
