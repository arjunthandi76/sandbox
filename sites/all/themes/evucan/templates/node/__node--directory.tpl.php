...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
   ...
   // dpm($node);
    ...
    <?php 
			if (!empty($node->field_shr_loc_address[LANGUAGE_NONE][0]['street']) && isset($node->field_shr_loc_address[LANGUAGE_NONE][0]['street'])) {
        $address= $node->field_shr_loc_address[LANGUAGE_NONE][0]['street'] . ", ";
        if ($node->field_shr_loc_address[LANGUAGE_NONE][0]['additional'] !==""){
          $address .= $node->field_shr_loc_address[LANGUAGE_NONE][0]['additional']. ", " ;
        }
        $address .= $node->field_shr_loc_address[LANGUAGE_NONE][0]['city'] . ", " . $node->field_shr_loc_address[LANGUAGE_NONE][0]['postal_code'];
      ...
      */
			if (!empty($node->field_shr_website) && isset($node->field_shr_website[LANGUAGE_NONE][0]['url'])) {
			  print '<div class="field website"><div class="field-value"><a href="'. $node->field_shr_website[LANGUAGE_NONE][0]['display_url'] .'">'.$node->field_shr_website[LANGUAGE_NONE][0]['title'].'</a></div></div>';
			}     
    ...
    if (!empty($node->field_dir_prod_services[LANGUAGE_NONE][0])) {
      ...
      <div class="right-col">
        <?php   // print views_embed_view('location_gmap', $display_id = 'loc_gmap');?>
      </div>
</div>